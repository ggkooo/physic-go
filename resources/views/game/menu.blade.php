<div class="d-flex flex-column align-items-center mt-4">
    ...
    <div class="col-10 col-md-3 mb-4">
        <a href="/game/new" class="btn btn-danger w-100 p-3 btn-default btn-raise">NOVO JOGO</a>
    </div>
    ...
    <div class="col-10 col-md-3 mb-4">
        <a href="" class="btn btn-danger w-100 p-3 btn-default btn-raise">RANKING ESCOLA</a>
    </div>

    <div class="col-10 col-md-3 mb-4">
         <a href=""><button class="btn btn-danger w-100 p-3 btn-default btn-raise">REGRAS</button></a>
    </div>
