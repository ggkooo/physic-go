    ...
    <div class="col-md-9 mb-2">
        ...
        <div class="d-flex flex-column align-items-center mt-4">
            <div class="col-12 col-md-4 mb-4">
                <button class="btn btn-danger w-100 p-3 btn-default btn-raise">6º ANO</button>
            </div>
            <div class="col-12 col-md-4 mb-4">
                <button class="btn btn-danger w-100 p-3 btn-default btn-raise">7º ANO</button>
            </div>
            <div class="col-12 col-md-4 mb-4">
                <button class="btn btn-danger w-100 p-3 btn-default btn-raise">8º ANO</button>
            </div>
             <div class="col-12 col-md-4 mb-4">
                <button class="btn btn-danger w-100 p-3 btn-default btn-raise">9º ANO</button>
            </div>
        </div>
    </div>
