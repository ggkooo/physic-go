<div class="d-flex flex-column align-items-center mt-4">
    ...
    <div class="col-10 col-md-3 mb-4">
         <a href="{{ route('credits') }}"><button class="btn btn-danger w-100 p-3 btn-default btn-raise">CRÉDITOS</button></a>
    </div>
    <div class="col-10 col-md-3 mb-4">
        <a href="{{ route('contact') }}"><button class="btn btn-danger w-100 p-3 btn-default btn-raise">CONTATO</button></a>
    </div>
    <div class="row">
        <a href="{{ route('logout') }}"
