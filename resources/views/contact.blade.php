    ...
    <div class="col-md-10 d-flex justify-content-between">
        <div class="col-md-6 p-3">
            ...
            <div class="card card-contact mb-4 p-2">
                <div class="card-body d-flex justify-content-center">
                    <div class="row col-md-12">
                        <span class="mb-3">Professores Coordenadores</span>
                        <div class="mb-3">
                            Edson Padoin
                            <a href="mailto:padoin@unijui.edu.br" class="text-email text-decoration-none small">padoin@unijui.edu.br</a>
                        </div>
                        <div class="mb-3">
                            Barbara Gündel
                            <a href="mailto:barbara.gundel@unijui.edu.br" class="text-email text-decoration-none small">barbara.gundel@unijui.edu.br</a>
                        </div>
                    </div>
                </div>
            </div>
